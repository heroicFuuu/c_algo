...
int main(int argc, char** argv) {
    ...
    // Case 1: 20 筆（已排序）
    int a20[20] = {0,   3,   7,   11,  50,  75,  100, 123, 150, 175,
    ...
    run_case("unsorted20 -> via sort", func1, unsorted20, size6);
    ...
    run_case("unsorted_mixed -> via sort", func1, unsorted_mixed, size7);
